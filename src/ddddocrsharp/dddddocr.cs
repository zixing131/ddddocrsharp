...
namespace ddddocrsharp
{
    public class dddddocr
    {
        ...
        /// </summary>
        Tensor<float> ExtractPixels2(Mat image)
        {
        ...
        /// Extracts pixels into tensor for net input.
        /// </summary>
        Tensor<float> ExtractPixels(Mat image)
        {
            // image = image.Transpose();//#InputArray.Create(new byte[] { 2, 0, 1 })
            //image.SaveImage("333.jpg");
        ...
        List<int> expanded_strides = new List<int>();
        ...
        /// </summary>
        List<DetResult> ParseDetect(DenseTensor<float> output, Mat image)
        {
            //var max = output.Max();
            //var min = output.Min();
        ...
        List<int> getOrder(List<float> data)
        {
